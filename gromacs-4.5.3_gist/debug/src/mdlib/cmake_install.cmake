...
FILE(INSTALL DESTINATION "/usr/local/gromacs/lib" TYPE SHARED_LIBRARY FILES
    "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/mdlib/libmd.so.6"
    "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/mdlib/libmd.so"
    )
  FOREACH(file
      "$ENV{DESTDIR}/usr/local/gromacs/lib/libmd.so.6"
      "$ENV{DESTDIR}/usr/local/gromacs/lib/libmd.so"
    ...
    IF(EXISTS "${file}" AND
      ...
      FILE(RPATH_CHANGE
           FILE "${file}"
           OLD_RPATH "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/gmxlib:/usr/local/lib:"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "development")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/gromacs/lib/pkgconfig" TYPE FILE RENAME "libmd.pc" FILES "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/mdlib/libmd.pc")
