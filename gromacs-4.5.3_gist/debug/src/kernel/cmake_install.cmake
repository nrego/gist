...
FILE(INSTALL DESTINATION "/usr/local/gromacs/lib" TYPE SHARED_LIBRARY FILES
    "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/kernel/libgmxpreprocess.so.6"
    "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/kernel/libgmxpreprocess.so"
    )
  FOREACH(file
      "$ENV{DESTDIR}/usr/local/gromacs/lib/libgmxpreprocess.so.6"
      "$ENV{DESTDIR}/usr/local/gromacs/lib/libgmxpreprocess.so"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "mdrun")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/gromacs/bin" TYPE EXECUTABLE FILES "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/kernel/mdrun_gist")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/gromacs/bin/mdrun_gist" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/gromacs/bin/mdrun_gist")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/gromacs/bin/mdrun_gist"
         OLD_RPATH "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/kernel:/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/mdlib:/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/gmxlib:/usr/local/lib:"
         NEW_RPATH "/usr/local/gromacs/lib:/usr/local/lib")
    IF(CMAKE_INSTALL_DO_STRIP)
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "runtime")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/gromacs/bin" TYPE EXECUTABLE FILES "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/kernel/grompp_gist")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/gromacs/bin/grompp_gist" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/gromacs/bin/grompp_gist")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/gromacs/bin/grompp_gist"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "runtime")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/gromacs/bin" TYPE EXECUTABLE FILES "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/kernel/tpbconv_gist")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/gromacs/bin/tpbconv_gist" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/gromacs/bin/tpbconv_gist")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/gromacs/bin/tpbconv_gist"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "runtime")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/gromacs/bin" TYPE EXECUTABLE FILES "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/kernel/pdb2gmx_gist")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/gromacs/bin/pdb2gmx_gist" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/gromacs/bin/pdb2gmx_gist")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/gromacs/bin/pdb2gmx_gist"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "runtime")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/gromacs/bin" TYPE EXECUTABLE FILES "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/kernel/g_protonate_gist")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/gromacs/bin/g_protonate_gist" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/gromacs/bin/g_protonate_gist")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/gromacs/bin/g_protonate_gist"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "runtime")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/gromacs/bin" TYPE EXECUTABLE FILES "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/kernel/g_luck_gist")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/gromacs/bin/g_luck_gist" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/gromacs/bin/g_luck_gist")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/gromacs/bin/g_luck_gist"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "runtime")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/gromacs/bin" TYPE EXECUTABLE FILES "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/kernel/gmxdump_gist")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/gromacs/bin/gmxdump_gist" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/gromacs/bin/gmxdump_gist")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/gromacs/bin/gmxdump_gist"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "runtime")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/gromacs/bin" TYPE EXECUTABLE FILES "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/kernel/g_x2top_gist")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/gromacs/bin/g_x2top_gist" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/gromacs/bin/g_x2top_gist")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/gromacs/bin/g_x2top_gist"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "runtime")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/gromacs/bin" TYPE EXECUTABLE FILES "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/kernel/gmxcheck_gist")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/gromacs/bin/gmxcheck_gist" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/gromacs/bin/gmxcheck_gist")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/gromacs/bin/gmxcheck_gist"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "development")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/gromacs/lib/pkgconfig" TYPE FILE RENAME "libgmxpreprocess.pc" FILES "/usr/local/src/gist/gromacs-4.5.3_gist/debug/src/kernel/libgmxpreprocess.pc")
